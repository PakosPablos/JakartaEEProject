...
The prompt that i used for this is as follows:
I will use this to learn so please refrain from giving me the answers directly, use examples and visualization to lead me to the right path. And very often i will use this to understand something better not to get the answer right away

And the model used as chatgpt 5


# Links

Link to my youtube video: 
https://youtu.be/UiMxWpHK-fI
